...
public final class Equalizer: ObservableObject, Identifiable {
  ...
  @Published public internal(set) var eqEnabled = false
  @Published public internal(set) var level63Hz = 0
  @Published public internal(set) var level125Hz = 0
  @Published public internal(set) var level250Hz = 0
  @Published public internal(set) var level500Hz = 0
  @Published public internal(set) var level1000Hz = 0
  @Published public internal(set) var level2000Hz = 0
  @Published public internal(set) var level4000Hz = 0
  @Published public internal(set) var level8000Hz = 0
